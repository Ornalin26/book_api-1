...
uri = "mongodb+srv://uuuuuserrr:passsass@cluster0.9ornc.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"

# Connect to MongoDB
client = MongoClient(uri)
db = client["Bookky"]
collection = db["Bookky"]
...
def check_password():
    ...
    correct_password = "1234"  # à¸£à¸«à¸±à¸ªà¸à¹à¸²à¸à¸à¸µà¹à¸à¸¹à¸à¸à¹à¸­à¸
